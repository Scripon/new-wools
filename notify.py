...
push_config = {
    ...
    'WP_APP_TOKEN_ONE': 'AT_2Lf0Q5NG6KenZrMIrWwJhqDIxvrDsNgc',             # wxpusher
}
notify_function = []
# fmt: on
...
def wxpusher(content: str, summary: str, uids: list) -> None:
    """
    使用 wxpusher 推送消息
    https://wxpusher.zjiecode.com/docs/#/?id=send-msg
    """
    if not push_config.get("WP_APP_TOKEN_ONE"):
        print("wxpusher 服务的 WP_APP_TOKEN_ONE 未设置!!\n取消推送")
        return
    print("wxpusher 服务启动")
    url = 'http://wxpusher.zjiecode.com/api/send/message'
    payload = {
        "appToken": push_config.get("WP_APP_TOKEN_ONE"),
        "content": content,
        "summary": summary,
        "contentType": 1,  # 文件类型
        "topicIds": [],
...
if __name__ == "__main__":
    content = """
            您的账号已经失效，请及时登录 小工具app(jdbonus) 获取新的cookie, 并在app内点击发送, Cookie将立即重新生效, 谢谢~
            😄😄😄😄😄😄
            ps: app下载地址: https://www.pgyer.com/bNA3 , 密码: 1231234。
            注意: IOS用户需到 设置-通用-VPN与设备管理-在企业级app选择刚安装的应用, 信任
            """
    summary = 'Cookie 失效提醒, 请关注!!!'
    wxpusher(content, summary, ["UID_5DTh39RDQfHsr8qHQ5hIMqE3of7F"])
